...
#define PARAVIRT_PATCH_pv_irq_ops 200 /* offsetof(struct paravirt_patch_template, pv_irq_ops)	# */
...
#define LGUEST_DATA_pgdir 1376 /* offsetof(struct lguest_data, pgdir)	# */
